...
type Projects struct {
	...
	Style         *string `json:"style" form:"style" gorm:"column:style;comment:画面风格(realistic, anime等);size:50;"`
	Genre         *string `json:"genre" form:"genre" gorm:"column:genre;comment:题材(都市, 古言, 悬疑);size:50;"`
