...
func ShotsSave(data interface{}, c *gin.Context) map[string][]string {
    rules := govalidator.MapData{
        ...
        "angle": []string{"max:50"},
        "dialogue": []string{"max:255"},
        "visualDesc": []string{"max:255"},
        "atmosphere": []string{"max:255"},
        "imagePrompt": []string{"max:255"},
        "videoPrompt": []string{"max:255"},
        "audioPrompt": []string{"max:255"},
    ...
    messages := govalidator.MapData{
        ...
        "visualDesc": []string{
             "max:画面描述长度不能超过 255 个字符",
        },
        "atmosphere": []string{
             "max:氛围/环境描述长度不能超过 255 个字符",
        },
        "imagePrompt": []string{
             "max:绘画Prompt长度不能超过 255 个字符",
        },
        "videoPrompt": []string{
             "max:视频生成Prompt长度不能超过 255 个字符",
        },
        "audioPrompt": []string{
             "max:音效/BGM提示词长度不能超过 255 个字符",
        },
        "imageUrl": []string{
