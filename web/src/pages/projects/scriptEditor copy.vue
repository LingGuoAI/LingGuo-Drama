...
const selectedVideoModel = ref('doubao-seedance-1-5-pro')
...
const videoModelCapabilities = ref<VideoModelCapability[]>([
    ...
    { id: 'doubao-seedance-1-5-pro', name: '豆包 (Seedance)', supportSingleImage: true, supportMultipleImages: true, supportFirstLastFrame: true, supportTextOnly: true, maxImages: 6 },
